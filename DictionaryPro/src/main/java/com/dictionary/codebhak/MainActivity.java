...
import com.dictionary.codebhak.wordbook.WordbookHistoryListFragment1;
import com.dictionary.codebhak.wordbook.WordbookHistoryListFragment2;
import com.dictionary.codebhak.wordbook.WordbookHistoryListFragment3;
import com.dictionary.codebhak.wordbook.WordbookHistoryListFragment4;
  ...
  //  }
    ...
    public void onItemSelected(String fragmentName) {
        switch (fragmentName) {
            ...
            case WordbookHistoryListFragment.NAME:
                ...
                break;
            case WordbookHistoryListFragment1.NAME:

                break;

            case WordbookHistoryListFragment2.NAME:

                break;
            case WordbookHistoryListFragment3.NAME:

                break;

            case WordbookHistoryListFragment4.NAME:
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (mMode.isWordbookMode()) {
            ...
            restoreActionBar();
            MenuItem itemSwitch=menu.findItem(R.id._lang);
            itemSwitch.setActionView(R.layout.use_switch);
            final Switch sw=(Switch) menu.findItem(R.id._lang).getActionView().findViewById(R.id.action_switch);
            sw.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    ...
                    if(b)
                    {
                        startActivity(new Intent(getBaseContext(), Chnage_lang.class));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.action_help:
            ...
            case R.id._lang:
                startActivity(new Intent(MainActivity.this,Chnage_lang.class));
                return true;
    ...
    private void Aboutus() {
        mMode = Mode.ABOUT_US;
        mTitle = getString(R.string.title_wordbook);
        mSubtitle = getString(R.string.about);
        restoreActionBar();
      //  swapInFragments(new WordbookBrowseListFragment(), new WordbookDetailFragment());
        Intent i=new Intent(MainActivity.this,Aboutus.class);
        startActivity(i);
        ensureNavDrawerSelection(Mode.ABOUT_US);
    }
    private void realtime() {
        mMode = Mode.REAL;
        mTitle = getString(R.string.title_wordbook);
        mSubtitle = getString(R.string.real_time);
        restoreActionBar();
        //  swapInFragments(new WordbookBrowseListFragment(), new WordbookDetailFragment());
        Intent i=new Intent(MainActivity.this,Real_Time.class);
        startActivity(i);
        ensureNavDrawerSelection(Mode.REAL);
    }

    private void  share() {
        mMode = Mode.SHARE;
        mTitle = getString(R.string.title_wordbook);
        mSubtitle = getString(R.string.share);
        restoreActionBar();
        //swapInFragments(new WordbookBrowseListFragment(), new WordbookDetailFragment());
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps"));
        startActivity(intent);
        //startActivity(i);
        ensureNavDrawerSelection(Mode.SHARE);
    }

    private void contactme() {
        mMode = Mode.CONTACT_US;
        mTitle = getString(R.string.title_wordbook);
        mSubtitle = getString(R.string.contactus);
        restoreActionBar();
        //swapInFragments(new WordbookHistoryListFragment1(), new WordbookDetailFragment());
        Intent i=new Intent(MainActivity.this,contactus.class);
        startActivity(i);
        ensureNavDrawerSelection(Mode.CONTACT_US);
    }
