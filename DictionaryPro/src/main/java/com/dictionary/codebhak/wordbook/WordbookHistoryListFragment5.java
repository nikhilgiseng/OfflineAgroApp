 ...
 */
public class WordbookHistoryListFragment5 extends AbstractWordbookListFragment
        implements LoaderManager.LoaderCallbacks<Cursor>{
    public static final String NAME = "bhushan";
     ...
     */
    public WordbookHistoryListFragment5() {
    }
