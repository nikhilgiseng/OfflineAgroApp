...
import com.dictionary.codebhak.Chnage_lang;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_add_favorite:
                WordbookDetailFragment addFavoriteFragment = (WordbookDetailFragment) getFragmentManager()
            ...
            /*case R.id.action_sound1:
                //this.mSound = "dummy.mp3";
                if (!this.mSound.equals("")){
                    soundPlayer.playSound1(this.mSound);
            ...
            //    startActivity(new Intent(MainActivity.this,Chnage_lang.class));
                ToggleButton mSwitchShowSecure = null;
                //mSwitchShowSecure = (ToggleButton) menu.findItem(R.id._lang1).getActionView().findViewById(R.id.);
                mSwitchShowSecure.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                        if(b){
                            //Your code when checked
                           // Toast.makeText(getApplication(),"Hi",Toa)
